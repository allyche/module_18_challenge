...
def setup():
    ...
    return PyChain([Block(Record("Genesis", "Genesis", 0), 0, 0)])


st.markdown("# Module 18 Challenge: PyChain")
...
# YOUR CODE HERE
sender = st.text_input("Enter the sender name")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver = st.text_input("Enter the receiver name")
